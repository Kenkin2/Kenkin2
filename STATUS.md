...
_Last updated: 21 May 2026 · v3.21.0_
...
- Payroll Summary — core navigation for all plans; Xero, Sage50, and CSV export
...
### Platform features
- Billing and subscriptions — Starter (£39/mo) · Growth (£79/mo) · Scale (£129/mo) via Stripe
- SAIS AI add-ons — 9 optional AI modules (£19–£99/mo), BYOK support, usage metering
...
- Personal Data Vault — GDPR Art.20 export + Art.17 erasure, full audit trail
