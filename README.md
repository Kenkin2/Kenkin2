...
| Role | Access |
| --- | --- |
| **Admin** | Full system access — manages organisation settings, billing, all staff records, payroll exports, compliance tasks, reporting, communications, automation, and AI tools |
