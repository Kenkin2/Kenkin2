...
_Version: v3.21.0 · Last updated: May 2026_
...
| **Backend** | Node.js + Express + TypeScript | REST architecture, cursor-based pagination |
| **Database** | Neon PostgreSQL | Drizzle ORM, connection pooling, read replicas, serverless-compatible |
...
| **AI / LLMs** | OpenAI GPT-4o · Anthropic Claude · Google Gemini | Multi-model routing via AI orchestrator, model failover chain |
...
| **Deployment** | Fly.io (London — LHR) | kin2serviceslimited.co.uk — UK data residency |
...
6 active AI agents run as background services. Each agent has a defined scope, input/output schema, and human-in-the-loop checkpoints (GDPR Article 22 compliant). Active agents:
- Compliance monitoring
- Payroll validation
- Scheduling optimisation
- Tender preparation (pending external API configuration)
- Grant intake (pending external API configuration)
- Founder oversight

Additional AI capabilities implemented as services (not standalone agents): demand forecasting, timesheet fraud detection, right-to-work document intelligence, shift anomaly detection.
